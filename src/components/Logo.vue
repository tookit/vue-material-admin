...
<template>
  <div style="line-height: 0; color: rgb(var(--v-theme-primary))" class="logo">
    <svg :height="height" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 91.03 61.5">
      <path d="M71.73,61.5H91L69.16,24.68h-19C57.44,37,64.57,49.15,71.73,61.5Z" :fill="secondary" fill-rule="evenodd" />
      <path
