          ...
          <v-widget title="Basic Usage">
            <div slot="widget-content">
              <v-container>
                ...
                <v-layout row>
                  <v-flex xs4> <v-subheader>Normal with hint text/label</v-subheader> </v-flex>
                  <v-flex xs8>
                ...
                <v-layout row>
                  <v-flex xs4> <v-subheader>Normal with input text + label</v-subheader> </v-flex>
                  <v-flex xs8>
                ...
                <v-layout row>
                  <v-flex xs4> <v-subheader>Single line (no hint) </v-subheader> </v-flex>
                  <v-flex xs8>
                    <v-text-field
                      name="input-4"
                      label="Label Text"
                ...
                <v-layout row>
                  <v-flex xs4> <v-subheader>Character counter </v-subheader> </v-flex>
                  <v-flex xs8>
                    <v-text-field
                      name="input-6"
                      label="Label Text"
                ...
                <v-layout row>
                  <v-flex xs4> <v-subheader>Prepend icon </v-subheader> </v-flex>
                  <v-flex xs8>
                    <v-text-field
                      name="input-7"
                      label="Label Text"
                ...
                <v-layout row>
                  <v-flex xs4> <v-subheader>Prefix for dollar currency</v-subheader> </v-flex>
                  <v-flex xs8> <v-text-field label="Amount" value="10.00" prefix="$"></v-text-field> </v-flex>
                </v-layout>
                <v-layout row>
                  <v-flex xs4> <v-subheader>Suffix for weight</v-subheader> </v-flex>
                  <v-flex xs8> <v-text-field label="Weight" value="28.00" suffix="lbs"></v-text-field> </v-flex>
                </v-layout>
                <v-layout row>
                  <v-flex xs4> <v-subheader>Suffix for email domain</v-subheader> </v-flex>
                  <v-flex xs8>
                    <v-text-field label="Email address" value="example" suffix="@gmail.com"></v-text-field>
                  </v-flex>
                </v-layout>
                <v-layout row>
                  <v-flex xs4> <v-subheader>Suffix for time zone</v-subheader> </v-flex>
                  <v-flex xs8>
                    <v-text-field label="Label Text" value="12:30:00" type="time" suffix="PST"></v-text-field>
                  </v-flex>
                </v-layout>
                <v-layout row>
                  <v-flex xs4> <v-subheader>Input with mask</v-subheader> </v-flex>
                  <v-flex xs8>
